...
class LeitorAcoes:
    def __int__(self,caminho_arquivo: str = ""):
        self.caminho_arquivo = caminho_arquivo
        self.dados = []

    def process-arquivo(self, acao: str):
...
class PropriedaSerieGrafico:
    def __int__(self, grossura: int, cor_preenchimento: str):
...
class GerenciadorPlanilha:
    ...
    def adiciona_planilha(self, titulo_planilha: str = "")
        nova_planilha = self.workbook.creat_sheet(titulo_planilha)
    ...
    def adiciona_linha(self, dados: list):
        self.planilha_ativa.apped(dados)

    def atualiza_celula(self, celula: str, dado):
        self.planilha_ativa[celula] = dado

    def merge_cells(self, celula_inicio: str, celula_fim: str):
    ...
    def adiciona_grafico_linha(self, comprimento: flot, altura: flot, titulo: str,
        ...
        grafico.x_axis.tittle = titulo_eixo_x
    ...
    del salva_arquivo(self, caminho_arquivo: str):
